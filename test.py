...
# Model
parser.add_argument('--perceptual_model', type=str, default='check_point/my_model/trainv1/model_300.pt',
                    help='perceptual model name')
parser.add_argument('--psnr_model', type=str, default='check_point/my_model/pretrain/best_model.pt',
